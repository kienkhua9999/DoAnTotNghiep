...
exports.danhsach_detai = (req, res) => {
    pool_db.connect(function (err, client, done) {
        ...
        client.query(`SELECT * FROM detais inner join chudes on detais."IDchude" = chudes."IDchude" inner join hoidongs on detais."IDhoidong" = hoidongs."IDhoidong"`, function (err, result) {
            done();
                                            ...
                                            client.query(`SELECT * FROM detais inner join chudes on detais."IDchude" = chudes."IDchude" inner join hoidongs on detais."IDhoidong" = hoidongs."IDhoidong"`, function (err, result) {
                                                ...
                                                if (err) {
                                                    ...
                                                    pool_db.connect(function (err, client, done) {
                                                        ...
                                                        client.query(`SELECT * FROM chudes where "IDchude" != ${chon_detai.rows[0].IDchude} `, function (err, result) {
                                                            done();
                                                            ...
                                                            if (err) {
                                                                ...
                                                                pool_db.connect(function (err, client, done) {
                                                                    ...
                                                                    client.query(`SELECT * FROM hoidongs where "IDhoidong" != ${chon_detai.rows[0].IDhoidong} `, function (err, result) {
                                                                        done();
                                                                        ...
                                                                        if (err) {
                                                                            ...
                                                                            res.render("./detai.ejs", {chon_detai:chon_detai.rows[0],chon_chude:chon_chude,chon_hoidong:chon_hoidong, chude:chude, ds_detai: ds_detai,hoidong:hoidong});
                                                                        }
                                                                    });
                                                                });
                                                            }
...
exports.them_detai = (req, res) => {
    Detai.create({
        ...
        banmendoan:req.body.banmendoan,
